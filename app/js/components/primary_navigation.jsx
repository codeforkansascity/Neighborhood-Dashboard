  ...
  render() {
    return (
      <div>
        ...
        >
          <form
            className="neighborhood-search form-inline"
            role="search"
            onSubmit={this.searchNeighborhood}
          >
            ...
            <div className="modal-body">
              {this.state.searchFailure && <p className="alert alert-danger fade in">
                <span
                  ...
                  aria-label="close"
                  title="close"
                  onClick={this.dismissSearchFailureMessage}
                >×</span>
                Neighborhood Not Found
              </p>}
              <p className="form-group">
                <label htmlFor="neighborhood-search">Find Neighborhood</label>
                <NeighborhoodSearch />
              </p>
              <p className="form-group">
                <label htmlFor="neighborhood-address">Or</label>
                <input
                  type="text"
                  id="neighborhood-address"
                  onChange={this.neighborhoodSearchChange}
                  name="search_address"
        ...
        <nav className="navbar navbar-default">
          <div className="navbar-header">
            ...
            ><span className="logo-prefix">KC</span>NeighborhoodStat</a>
          </div>
            ...
            <ul className="nav navbar-nav navbar-right">
              ...
              <li>
                <a
                  ...
                  data-toggle="modal"
                  data-target="#neighborhood-search-modal"
                >Neighborhood Search</a></li>
            </ul>
          </nav>
        </nav>
      </div>
